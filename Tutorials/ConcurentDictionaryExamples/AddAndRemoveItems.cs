...
namespace ConcurentDictionaryExamples
{

    // The type of the Value to store in the dictionary : Link: https://docs.microsoft.com/en-us/dotnet/standard/collections/thread-safe/how-to-add-and-remove-items 
